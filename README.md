...
4. app/proguard-rules.pro 增加如下
   ...
   ```
5. 客户端获取本地应用的原始安装apk(详情见com.jfeng.usesodemo.MainActivity)
6. 调用工具类 jfeng-bspatch_v1.0.jar 中的 com.jfeng.bspatchlibrary.BsPatch的方法bspatch
   进行合成新的APK(详情见com.jfeng.usesodemo.MainActivity)
7. 获取新的APK文件的MD5值和服务端返回的MD5进行比较是否相等,相等表示合成的新APK是本次升级后的安装文件(详情见com.jfeng.usesodemo.MainActivity)
